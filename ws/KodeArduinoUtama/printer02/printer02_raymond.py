...
def hitungJumlahData(ws1):
  ws1=ws1.strip()
  q00="select count(*) from mat_d_statusbarcode01 where STATUS is null and workstation='"+ws1+"'"
  #q00="select count(*) from MAT_D_STATUSBARCODE where STATUS is null"
  cursor.execute(q00)
...
##  id1=""
##  try:
##    q00="select top 1 * from mat_d_statusbarcode01 where STATUS is null and workstation='"+ws00+"' order by ID"
##    q00="select top 1 * from MAT_D_STATUSBARCODE where STATUS is null order by ID"
##    cursor.execute(q00)
##    tabel0=cursor.fetchall()  
##    id1=str(tabel0[0][0])
##    id1=id1.strip()
...
def cariNamaMaterial(ws00,cur00):
  nama00=""
  id1=id1.strip()
  try:
    ...
    q00=q00+"Z0.id=(SELECT id FROM mat_d_statusbarcode0101 WHERE workstation='"
