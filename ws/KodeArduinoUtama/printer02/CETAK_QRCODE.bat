@echo off
REM =====================================================
REM Script untuk cetak QR code manual
REM =====================================================
REM Double-click file ini untuk mulai cetak QR code
REM =====================================================

setlocal enabledelayedexpansion

title CETAK QR CODE MANUAL
...
echo.
echo ===================================================
echo Starting QR Code Printing Script...
echo ===================================================
echo.
